...
object Constants {
    ...
    const val ACTION_CHANGE_WALLPAPER_AUTO = "com.anthonyla.paperize.ACTION_CHANGE_WALLPAPER_AUTO"
    const val ACTION_EXACT_WALLPAPER_ALARM = "com.anthonyla.paperize.ACTION_EXACT_WALLPAPER_ALARM"
    const val ACTION_CHANGE_WALLPAPER_FAST = "com.anthonyla.paperize.ACTION_CHANGE_WALLPAPER_FAST"
    ...
    const val WORK_NAME_SCREEN_EVENT = "wallpaper_change_screen_event"
    const val WORK_TAG_SCREEN_EVENT = "wallpaper_change_screen_event_tag"
...
object PreferenceKeys {
    ...
    const val CHANGE_ON_LOCK_UNLOCK = "change_on_lock_unlock"
